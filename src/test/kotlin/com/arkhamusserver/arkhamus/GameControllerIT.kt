...
class GameControllerIT {
    ...
    fun `create game session`() {
        ...
        val gameSession = gameController.create(host.id!!).body!!
        ...
        assertEquals(usersOfGame.first().gameSession!!.id, createdGameSession.id)
    ...
    fun `join to the game`() {
        ...
        val player2 = users.elementAt(1)!!.id!!
        gameController.connect(player2, gameSession.id!!)
        ...
        assertEquals(usersOfGame.first { !it.host!! }.userAccount!!.id, player2)
    ...
    fun `start the game`() {
        ...
        val player2 = users.elementAt(1)!!.id!!
        gameController.connect(player2, gameSession.id!!)
        gameController.start(host.id!!, gameSession.id!!)
