...
class SteamReaderLogic(
    ...
    fun readSteamUserData(steamId: String): SteamUserResponse {
        LoggingUtils.withContext(
            ...
            logger.debug("Fetching Steam user data for SteamID: {}", steamId)
        }
        try {
            ...
            if (response != null) {
                LoggingUtils.withContext(
                    ...
                    logger.debug("Successfully fetched user data for SteamID: {}", steamId)
                }
            ...
            LoggingUtils.withContext(
                ...
                logger.error("Error fetching Steam user data for SteamID: {}", steamId, e)
            }
