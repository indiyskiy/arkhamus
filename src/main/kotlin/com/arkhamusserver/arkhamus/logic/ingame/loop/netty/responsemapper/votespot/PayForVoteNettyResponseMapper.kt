...
import com.arkhamusserver.arkhamus.view.dto.netty.response.banvote.PayForVoteNettyResponse
import com.arkhamusserver.arkhamus.view.dto.netty.response.parts.MyGameUserResponse
import com.arkhamusserver.arkhamus.view.dto.netty.response.parts.OngoingEventResponse
import org.springframework.stereotype.Component

@Component
class PayForVoteNettyResponseMapper(
    ...
    override fun acceptClass(gameResponseMessage: RequestProcessData): Boolean =
        gameResponseMessage::class.java == PayForVoteRequestProcessData::class.java
    ...
    ): PayForVoteNettyResponse {
        (requestProcessData as PayForVoteRequestProcessData).let {
            return PayForVoteNettyResponse(
                successfullyPaid = it.successfullyPaid,
                tick = it.tick,
                userId = user.id!!,
