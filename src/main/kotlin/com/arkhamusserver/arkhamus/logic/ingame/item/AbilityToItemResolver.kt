    ...
    fun resolve(ability: Ability): Item? =
        if (!ability.requiresItem) {
            ...
            when (ability) {
                ...
                //clue search items
                //clue 2.0
                ADVANCED_SEARCH_FOR_INSCRIPTION -> INSCRIPTION_INVESTIGATION_ITEM
                ADVANCED_SEARCH_FOR_SCENT -> SCENT_INVESTIGATION_ITEM
                ADVANCED_SEARCH_FOR_SOUND -> SOUND_INVESTIGATION_ITEM
                ADVANCED_SEARCH_FOR_OMEN -> OMEN_INVESTIGATION_ITEM
                ADVANCED_SEARCH_FOR_CORRUPTION -> CORRUPTION_INVESTIGATION_ITEM
                ADVANCED_SEARCH_FOR_DISTORTION -> DISTORTION_INVESTIGATION_ITEM
                ADVANCED_SEARCH_FOR_AURA -> AURA_INVESTIGATION_ITEM
                //advanced items
