...
import com.arkhamusserver.arkhamus.view.dto.netty.response.quest.QuestDeclineNettyResponse
import org.springframework.stereotype.Component

@Component
class QuestDeclineNettyResponseMapper(
    ...
    override fun acceptClass(gameResponseMessage: RequestProcessData): Boolean =
        gameResponseMessage::class.java == QuestDeclineRequestProcessData::class.java
    ...
    ): QuestDeclineNettyResponse {
        (requestProcessData as QuestDeclineRequestProcessData).let {
            return QuestDeclineNettyResponse(
