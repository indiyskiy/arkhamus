...
import com.arkhamusserver.arkhamus.logic.ingame.loop.netty.netcode.ResponseSendingLoopManagerImpl
...
class AbilityNettyRequestHandler(
    ...
    companion object {
        private val logger = LoggingUtils.getLogger<AbilityNettyRequestHandler>()
    }
