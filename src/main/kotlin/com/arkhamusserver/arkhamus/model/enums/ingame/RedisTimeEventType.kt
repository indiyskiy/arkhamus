...
enum class RedisTimeEventType(
    ...
    DAY(DAY_LENGTH * MINUTE_IN_MILLIS, Visibility.PUBLIC),
    NIGHT(NIGHT_LENGTH * MINUTE_IN_MILLIS, Visibility.PUBLIC),

    //altar
    ALTAR_VOTING(DAY_LENGTH * MINUTE_IN_MILLIS / 2, Visibility.PUBLIC),
    RITUAL_GOING(DAY_LENGTH * MINUTE_IN_MILLIS / 2, Visibility.PUBLIC),
    ALTAR_VOTING_COOLDOWN(DAY_LENGTH * MINUTE_IN_MILLIS / 4, Visibility.PUBLIC),
